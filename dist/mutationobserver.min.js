// MutationObserver-Shim v0.2.2 (http://github.com/megawac/MutationObserver.js)
...
l=-1}-1===l?d.c&&b.push(t({type:"childList",target:a,addedNodes:[k]})):(g[f]=!0,h.push({h:v,i:l}))}v++}u&&u!==r[v]&&(k=f=C(u),g[k]===s&&(-1===(l=D.call(r,u,v))?d.c&&b.push(t({type:"childList",target:c.j,removedNodes:[u]})):(g[f]=!0,h.push({h:l,i:w}))),w++)}h&&m(h,a,r,e)}function m(a,c,e,m){for(var s=a.length-1,x=-~(s/2),g,h,f;f=a.pop();)g=e[f.h],h=m[f.i],d.c&&x&&Math.abs(f.h-f.i)>=s&&(b.push(t({type:"childList",target:c,addedNodes:[g],removedNodes:[g]})),x--),d.a&&h.a&&y(b,g,h.a,d.e),d.b&&3===g.nodeType&&
g.nodeValue!==h.b&&b.push(t({type:"characterData",target:g,oldValue:h.b})),d.d&&p(g,h)}p(a,c)},I=function(b,a){var c=A(b,a);return function(d){var e=d.length;a.a&&c.a&&y(d,b,c.a,a.e);(a.c||a.d)&&H(d,b,c,a);d.length!==e&&(c=A(b,a))}},e=function(b){var a=this;a.g=[];a.k=function(){var c=a.takeRecords();c.length&&b.call(a,c,a);a.f=setTimeout(a.k,e._period)}};e._period=30;e.prototype.observe=function(b,a){for(var c=this.g,d=0;d<c.length;d++)if(c[d].m===b){c.splice(d,1);break}d={a:!!(a.attributes||a.attributeFilter||
